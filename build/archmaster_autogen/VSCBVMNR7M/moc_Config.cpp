...
void Config::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Config::*)(bool )>(_a, &Config::darkModeChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Config::*)()>(_a, &Config::settingsChanged, 1))
            return;
    }
}
...
// SIGNAL 0
void Config::darkModeChanged(bool _t1)
{
